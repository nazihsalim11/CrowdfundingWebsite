      ...
      <main className="animate-fade-in">
          ...
          <div className="container animate-fade-in">
            <div style={{ display: 'flex', justifyContent: 'space-around', flexWrap: 'wrap', gap: '40px' }}>
              <div style={{ textAlign: 'center', minWidth: '180px' }}>
                <span style={{ color: 'var(--primary)', fontSize: '2.5rem', fontWeight: 800, fontFamily: 'var(--font-display)' }}>
                  ₹{(totalRaised / 100000).toFixed(1)}L+
                </span>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', marginTop: '6px', letterSpacing: '0.08em' }}>Total Raised</p>
              </div>
              <div style={{ textAlign: 'center', minWidth: '180px' }}>
                <span style={{ color: 'var(--text-primary)', fontSize: '2.5rem', fontWeight: 800, fontFamily: 'var(--font-display)' }}>
                  {campaigns.length}
                </span>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', marginTop: '6px', letterSpacing: '0.08em' }}>Active Projects</p>
              </div>
              <div style={{ textAlign: 'center', minWidth: '180px' }}>
                <span style={{ color: 'var(--text-primary)', fontSize: '2.5rem', fontWeight: 800, fontFamily: 'var(--font-display)' }}>
                  {totalInvestorsCount}
                </span>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', marginTop: '6px', letterSpacing: '0.08em' }}>Supporters</p>
              </div>
              <div style={{ textAlign: 'center', minWidth: '180px' }}>
                <span style={{ color: 'var(--success)', fontSize: '2.5rem', fontWeight: 800, fontFamily: 'var(--font-display)' }}>
                  100%
                </span>
                <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', marginTop: '6px', letterSpacing: '0.08em' }}>Audited Ledger</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: '160px 0' }}>
          <div className="container animate-scale-up">
            <div style={{ textAlign: 'center', marginBottom: '60px' }}>
              <span style={{ fontSize: '0.78rem', fontWeight: 700, color: 'var(--primary)', textTransform: 'uppercase', letterSpacing: '0.08em', display: 'block', marginBottom: '8px' }}>SPOTLIGHT</span>
              <h2 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.02em' }}>Featured Project</h2>
            </div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '60px', alignItems: 'center' }}>
              ...
              <div style={{ padding: '20px 0' }}>
                <div style={{ display: 'flex', gap: '8px', alignItems: 'center', marginBottom: '16px' }}>
                  ...
                  <span style={{ fontSize: '0.85rem', fontWeight: 600, color: 'var(--text-secondary)' }}>DIGITAL EDUCATION</span>
                </div>
                
                <h3 style={{ fontSize: '1.8rem', marginBottom: '16px', fontWeight: 800 }}>Smart Classrooms & VR Labs</h3>
                ...
                <div className="progress-container" style={{ margin: '24px 0 32px 0' }}>
                  <div className="progress-info" style={{ fontSize: '0.85rem', marginBottom: '8px' }}>
                    <span>80% Funded</span>
                    <span style={{ fontWeight: 700 }}>₹12,00,000 / ₹15,00,000</span>
                  </div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <div>
                    <span style={{ fontSize: '0.75rem', display: 'block', color: 'var(--text-tertiary)', fontWeight: 600 }}>EXPECTED RETURN</span>
                    <span style={{ fontWeight: 700, color: 'var(--text-primary)', fontSize: '1.05rem' }}>8.4% Annually</span>
                  </div>
        ...
        <section style={{ padding: '160px 0' }}>
          <div className="container">
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: '60px' }}>
              <div>
                <h2 style={{ fontSize: '2rem', fontWeight: 800, letterSpacing: '-0.02em' }}>Open Investments</h2>
              ...
              {activeCampaigns.map((camp) => {
                ...
                return (
                  <div className="card" key={camp.id} style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: '36px', border: '1px solid var(--border-color)' }}>
                    ...
                    <h3 className="card-title" style={{ fontSize: '1.25rem', fontWeight: 700, marginBottom: '24px', minHeight: '44px', lineHeight: '1.3' }}>{camp.title}</h3>
                    ...
                    <div className="progress-container" style={{ margin: 'auto 0 24px 0' }}>
                      <div className="progress-info" style={{ fontSize: '0.8rem', marginBottom: '8px' }}>
                        ...
                        <span style={{ fontWeight: 700 }}>₹{camp.raisedAmount.toLocaleString()}</span>
                      </div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid var(--border-color)', paddingTop: '20px' }}>
                      <div>
                        <span style={{ fontSize: '0.72rem', display: 'block', color: 'var(--text-tertiary)', fontWeight: 600 }}>ESTIMATED RETURN</span>
                        <span style={{ fontWeight: 700, color: 'var(--text-primary)', fontSize: '0.9rem' }}>{camp.roiEstimate.split(' ')[0]} {camp.roiEstimate.split(' ')[1] || ''}</span>
                      </div>
        ...
        <section style={{ padding: '160px 0', backgroundColor: 'var(--bg-secondary)' }}>
          <div className="container" style={{ maxWidth: '900px', textAlign: 'center' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '60px', letterSpacing: '-0.02em' }}>Designed for Accountability</h2>
            
            <div className="grid-3" style={{ gap: '50px' }}>
              <div style={{ textAlign: 'left' }}>
                <span style={{ fontSize: '1.8rem', display: 'block', marginBottom: '16px' }}>🔍</span>
                <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: '12px' }}>Audited Ledger</h3>
              ...
              <div style={{ textAlign: 'left' }}>
                <span style={{ fontSize: '1.8rem', display: 'block', marginBottom: '16px' }}>📈</span>
                <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: '12px' }}>Revenue Distribution</h3>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: '1.6' }}>
              ...
              <div style={{ textAlign: 'left' }}>
                ...
                <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: '12px' }}>Verified Credentials</h3>
                <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem', lineHeight: '1.6' }}>
        ...
        <section style={{ padding: '160px 0', textAlign: 'center' }}>
          <div className="container" style={{ maxWidth: '600px' }}>
            <h2 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '20px', letterSpacing: '-0.02em' }}>Explore Sandbox Portals</h2>
